...
EmployeeDog.create(employee_id: 1, dog_id: 2)
...
EmployeeDog.create(employee_id: 2, dog_id: 1)
...
EmployeeDog.create(employee_id: 3, dog_id: 3)
...
EmployeeDog.create(employee_id: 4, dog_id: 1)
...
EmployeeDog.create(employee_id: 5, dog_id: 4)
...
EmployeeDog.create(employee_id: 6, dog_id: 3)
...
EmployeeDog.create(employee_id: 7, dog_id: 5)
...
EmployeeDog.create(employee_id: 8, dog_id: 2)
...
EmployeeDog.create(employee_id: 9, dog_id: 4)
...
EmployeeDog.create(employee_id: 10, dog_id: 5)
